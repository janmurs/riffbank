...
initAppContext({ render, navigateForward, goBack, setHeader, syncTabs, getActiveScreenEl: () => activeScreenEl, _updateNotifBadge, resetSongsFilters, getSongsListState: () => songsListState, getProjectsOwnerFilter: () => projectsOwnerFilter, setProjectsOwnerFilter: (v) => { projectsOwnerFilter = v; } });
